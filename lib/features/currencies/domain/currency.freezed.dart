...
mixin _$Currency {
 ...
 int? get id; String get code; String get name; String get symbol; String get decimalChar; int get fracDigits; String get groupingChar;
...
@useResult
$Res call({
 int? id, String code, String name, String symbol, String decimalChar, int fracDigits, String groupingChar
});
...
as String,decimalChar: null == decimalChar ? _self.decimalChar : decimalChar // ignore: cast_nullable_to_non_nullable
as String,fracDigits: null == fracDigits ? _self.fracDigits : fracDigits // ignore: cast_nullable_to_non_nullable
as int,groupingChar: null == groupingChar ? _self.groupingChar : groupingChar // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String code,  String name,  String symbol,  String decimalChar,  int fracDigits,  String groupingChar)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Currency() when $default != null:
return $default(_that.id,_that.code,_that.name,_that.symbol,_that.decimalChar,_that.fracDigits,_that.groupingChar);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String code,  String name,  String symbol,  String decimalChar,  int fracDigits,  String groupingChar)  $default,) {final _that = this;
switch (_that) {
case _Currency():
return $default(_that.id,_that.code,_that.name,_that.symbol,_that.decimalChar,_that.fracDigits,_that.groupingChar);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String code,  String name,  String symbol,  String decimalChar,  int fracDigits,  String groupingChar)?  $default,) {final _that = this;
switch (_that) {
case _Currency() when $default != null:
return $default(_that.id,_that.code,_that.name,_that.symbol,_that.decimalChar,_that.fracDigits,_that.groupingChar);case _:
  return null;
...
class _Currency extends Currency {
  const _Currency({this.id, this.code = '', this.name = '', this.symbol = '', this.decimalChar = ',', this.fracDigits = 2, this.groupingChar = '.'}): super._();
...
@override@JsonKey() final  String decimalChar;
@override@JsonKey() final  int fracDigits;
@override@JsonKey() final  String groupingChar;
...
/// Create a copy of Currency
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? code = null,Object? name = null,Object? symbol = null,Object? decimalChar = null,Object? fracDigits = null,Object? groupingChar = null,}) {
