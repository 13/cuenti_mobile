...
bool operator ==(Object other) {
  final _this = this as TransactionSplit;
...
int get hashCode {
  final _this = this as TransactionSplit;
  return Object.hash(runtimeType,_this.amount,_this.id,_this.categoryId,_this.categoryName,_this.memo);
}

@override
String toString() {
  final _this = this as TransactionSplit;
  return 'TransactionSplit(amount: ${_this.amount}, id: ${_this.id}, categoryId: ${_this.categoryId}, categoryName: ${_this.categoryName}, memo: ${_this.memo})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,amount,id,categoryId,categoryName,memo);
}
