...
class UserRepository {
  ...
  // Admin
  Future<List<UserProfile>> getAllUsers() => guardApi(() async {
  ...
  Future<void> setUserEnabled(int id, {required bool enabled}) => guardApi(
    () => _dio.put<void>(
  ...
  Future<void> deleteUser(int id) =>
      guardApi(() => _dio.delete<void>('/user/admin/users/$id'));

  Future<AdminSettings> getAdminSettings() => guardApi(() async {
