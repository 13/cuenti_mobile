...
void main() {
  ...
  test(
    'getReport parses entries and totals, including nullable fields',
    () async {
      when(
  ...
  test(
    'getReport defaults totals and avg fields when report is empty',
    () async {
      when(
        () => dio.get<Map<String, dynamic>>(
          '/vehicles/report',
  ...
  test(
    'getReport always sends categoryId, even without a date range',
    () async {
      when(
        () => dio.get<Map<String, dynamic>>(
          '/vehicles/report',
